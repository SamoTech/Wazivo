      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    For GDPR/CCPA requests and privacy concerns
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <p className="text-gray-700 mb-6">Under GDPR and CCPA, you have the right to:</p>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
              <p className="text-sm text-gray-700">
                <strong>Important:</strong> Wazivo does NOT store uploaded resumes. All processing
                is done in real-time and data is immediately discarded after analysis. Therefore,
                there is no stored resume data to access or delete.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700">
                No. All resume processing is done in real-time, and data is immediately discarded
                after analysis completion. We do not store uploaded files or analysis results.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                Your resume data is only processed by our AI service (Groq) during analysis. No
                human reviews your data, and it's not shared with employers or third parties without
                your consent.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                Yes. All data transmission uses HTTPS encryption. Processing happens in secure
                serverless functions, and data is never stored on our servers.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                We respond to all GDPR/CCPA data rights requests within 30 days, as required by law.
                Most requests are processed much faster.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                Since we don't store resume data, there's nothing to retrieve. However, we can
                provide any analytics or log data associated with your usage (minimal and
                anonymized).
              </p>
            </div>
          </div>
