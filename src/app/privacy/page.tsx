        ...
        <div className="prose prose-lg max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Welcome to Wazivo ("we", "our", or "us"). We are committed to protecting your personal information and your right to privacy.
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              <li><strong>Resume/CV Content:</strong> Text extracted from uploaded files or URLs</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              <li><strong>Groq (AI Analysis):</strong> Resume text for AI-powered analysis</li>
              <li><strong>Adzuna/JSearch (Job APIs):</strong> Skills and preferences for job matching</li>
              <li><strong>Jina AI (URL Fetching):</strong> URLs you provide for content extraction</li>
              <li><strong>Vercel (Hosting):</strong> Technical data for website hosting</li>
            </ul>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              <strong>Important:</strong> Wazivo does NOT store your uploaded resumes or analysis results on our servers.
              All processing happens in real-time, and data is discarded after analysis completion.
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Wazivo is not intended for users under 16 years of age. We do not knowingly collect personal information from children.
