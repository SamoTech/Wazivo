 ...
 */
export function buildBaytAffiliateUrl(searchQuery: string, country: string = 'egypt'): string {
 ...
 */
export function trackAffiliateClick(platform: string, region: string, query: string): void {
  try {
