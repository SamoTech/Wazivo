  ...
  return (
    <div className={`rounded-3xl border bg-gradient-to-br p-6 ${toneMap[tone]}`}>
      <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-sm uppercase tracking-[0.22em] text-slate-400">{dict.scoreCard.score}</p>
        ...
        <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-right">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-400">{dict.scoreCard.careerLevel}</p>
